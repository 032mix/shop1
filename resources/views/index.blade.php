...
@section ('content')
    ...
    {{--<a href="single.blade.php" class="product-image"><img src="img/7.jpg" alt=" "--}}
    ...
    {{--</div>--}}
    {{--</div>--}}
    {{--<h4><a href="single.blade.php">Formal Shirt</a></h4>--}}
    {{--<p>Vel illum qui dolorem eum fugiat.</p>--}}
    {{--<div class="new-collections-grid1-left">--}}
    {{--<p><i>$325</i> <span class="">$250</span><a class="" href="#">add to--}}
    {{--cart </a></p>--}}
    {{--</div>--}}
    {{--</div>--}}
    {{--<div class="new-collections-grid1 animated wow slideInUp" data-wow-delay=".5s">--}}
    {{--<div class="new-collections-grid1-image">--}}
    {{--<a href="single.blade.php" class="product-image"><img src="img/8.jpg" alt=" "--}}
    {{--class="img-responsive"/></a>--}}
    {{--<div class="new-collections-grid1-image-pos">--}}
    {{--<a href="single.blade.php">Quick View</a>--}}
    {{--</div>--}}
    ...
    {{--</div>--}}
    {{--</div>--}}
    {{--<h4><a href="single.blade.php">Running Shoes</a></h4>--}}
    {{--<p>Vel illum qui dolorem eum fugiat.</p>--}}
    {{--<div class="new-collections-grid1-left">--}}
    {{--<p><i>$280</i> <span class="">$150</span><a class="" href="#">add to--}}
    {{--cart </a></p>--}}
    {{--</div>--}}
    {{--</div>--}}
    {{--</div>--}}
    ...
    {{--data-wow-delay=".5s">--}}
    {{--<div class="new-collections-grid1-image">--}}
    {{--<a href="single.blade.php" class="product-image"><img src="img/5.jpg" alt=" "--}}
    {{--class="img-responsive"/></a>--}}
    ...
    {{--</div>--}}
    {{--</div>--}}
    {{--<h4><a href="single.blade.php">Dining Table</a></h4>--}}
    {{--<p>Vel illum qui dolorem eum fugiat.</p>--}}
    {{--<div class="new-collections-grid1-left ">--}}
    {{--<p><i>$580</i> <span class="">$550</span><a class="" href="#">add to--}}
    {{--cart </a></p>--}}
    {{--</div>--}}
    {{--</div>--}}
    ...
    {{--<div class="new-collections-grid1 animated wow slideInUp" data-wow-delay=".5s">--}}
    {{--<div class="new-collections-grid1-image">--}}
    {{--<a href="single.blade.php" class="product-image"><img src="img/6.jpg" alt=" "--}}
    {{--class="img-responsive"/></a>--}}
    {{--<div class="new-collections-grid1-image-pos">--}}
    {{--<a href="single.blade.php">Quick View</a>--}}
    {{--</div>--}}
    ...
    {{--</div>--}}
    {{--</div>--}}
    {{--<h4><a href="single.blade.php">Wall Lamp</a></h4>--}}
    {{--<p>Vel illum qui dolorem eum fugiat.</p>--}}
    {{--<div class="new-collections-grid1-left">--}}
    {{--<p><i>$480</i> <span class="">$400</span><a class="" href="#">add--}}
    {{--to cart </a></p>--}}
    {{--</div>--}}
    {{--</div>--}}
    {{--</div>--}}
    ...
    {{--<div class="new-collections-grid1 animated wow slideInUp" data-wow-delay=".5s">--}}
    {{--<div class="new-collections-grid1-image">--}}
    {{--<a href="single.blade.php" class="product-image"><img src="img/9.jpg" alt=" "--}}
    {{--class="img-responsive"/></a>--}}
    {{--<div class="new-collections-grid1-image-pos">--}}
    {{--<a href="single.blade.php">Quick View</a>--}}
    {{--</div>--}}
    ...
    {{--<p>Vel illum qui dolorem eum fugiat.</p>--}}
    {{--<div class="new-collections-grid1-left">--}}
    {{--<p><i>$280</i> <span class="">$150</span><a class="" href="#">add--}}
    {{--to cart </a></p>--}}
    {{--</div>--}}
    {{--</div>--}}
    {{--</div>--}}
    ...
    {{--<div class="new-collections-grid1 animated wow slideInUp" data-wow-delay=".5s">--}}
    {{--<div class="new-collections-grid1-image">--}}
    {{--<a href="single.blade.php" class="product-image"><img src="img/10.jpg" alt=" "--}}
    {{--class="img-responsive"/></a>--}}
    {{--<div class="new-collections-grid1-image-pos">--}}
    {{--<a href="single.blade.php">Quick View</a>--}}
    {{--</div>--}}
    ...
    {{--</div>--}}
    {{--</div>--}}
    {{--<h4><a href="single.blade.php">Pearl & Stone Anklet</a></h4>--}}
    {{--<p>Vel illum qui dolorem eum fugiat.</p>--}}
    {{--<div class="new-collections-grid1-left">--}}
    {{--<p><i>$180</i> <span class="">$120</span><a class="" href="#">add to--}}
    {{--cart </a></p>--}}
    {{--</div>--}}
    {{--</div>--}}
    {{--<div class="new-collections-grid1 animated wow slideInUp" data-wow-delay=".5s">--}}
    {{--<div class="new-collections-grid1-image">--}}
    {{--<a href="single.blade.php" class="product-image"><img src="img/11.jpg" alt=" "--}}
    {{--class="img-responsive"/></a>--}}
    {{--<div class="new-collections-grid1-image-pos">--}}
    {{--<a href="single.blade.php">Quick View</a>--}}
    {{--</div>--}}
    ...
    {{--<p>Vel illum qui dolorem eum fugiat.</p>--}}
    {{--<div class="new-collections-grid1-left">--}}
    {{--<p><i>$340</i> <span class="">$257</span><a class="" href="#">add to--}}
    {{--cart </a></p>--}}
    {{--</div>--}}
    {{--</div>--}}
    {{--</div>--}}
    ...
    {{--<h3><a href="products.blade.php">sunt in culpa qui officia deserunt mollit</a></h3>--}}
    {{--<div class="rating">--}}
    {{--<div class="rating-left">--}}
    {{--<img src="img/2.png" alt=" " class="img-responsive"/>--}}
    {{--</div>--}}
    ...
    {{--<div class="clearfix"></div>--}}
    {{--</div>--}}
    {{--<div class="new-collections-grid1-left timer-grid-left-price">--}}
    {{--<p><i>$580</i> <span class="">$550</span></p>--}}
    ...
    {{--<p><a class="timer_add" href="#">add to cart </a></p>--}}
    {{--</div>--}}
    {{--<div id="counter"></div>--}}
